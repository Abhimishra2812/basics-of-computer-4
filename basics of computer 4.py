'1 )Write a step wise process on how to create a new user');get_ipython().run_line_magic('pinfo', 'user')
...
2 )When do we use Log off and when do we use shut down');get_ipython().run_line_magic('pinfo', 'down')
...
3 )Define what is a hard disk and write a step wise process to create a folder on your name on your hard disk');get_ipython().run_line_magic('pinfo', 'disk')
...
'4 )Write step wise process to open the folder that you have created on your name');get_ipython().run_line_magic('pinfo', 'name')
...
8 )What are some tasks performed by the file management system on a computer system');get_ipython().run_line_magic('pinfo', 'system')
